...
<main class="container" style="padding: 0">
  <a href="{{ route('verifikasi') }}" style="margin-bottom: 1rem;display:inline-block"><small> &leftarrow;
      Back</small></a>
  ...
  <div style="display: flex;">
    ...
    <ul style="flex: 1;margin:0;padding:0">
      ...
      <li style="list-style: none">
        <h6 style="width: 200px;display: inline-block;margin:0">Tanggal Pengaduan </h6> :
        {{$aduan->tgl_pengaduan}}
      </li>
      <li style="list-style: none">
        <div class="status">
  ...
  <div style="margin-bottom:var(--block-spacing-vertical)">
  ...
  <div class="grid">
    <a role="button" href="{{ route('verif_aduan', ['id' => $aduan->id_pengaduan])}}"
      data-tooltip="Validasi laporan untuk diproses selanjutnya.">Verif</a>
    <a role="button" href="{{ route('tolak_aduan', ['id' => $aduan->id_pengaduan])}}" class="secondary"
      data-tooltip="Tolak laporan.">Reject</a>
  </div>
</main>
@endsection