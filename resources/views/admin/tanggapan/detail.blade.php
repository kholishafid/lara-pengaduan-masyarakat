...
<main class="container" style="padding: 0">
  <a href="{{ route('aduan-selesai') }}" style="margin-bottom: 1rem;display:inline-block"><small> &leftarrow;
      Back</small></a>
  ...
  <div style="display: flex;">
    ...
    <ul style="flex: 1;margin:0;padding:0">
      ...
      <li style="list-style: none">
        <h6 style="width: 200px;display: inline-block;margin:0">Pengadu</h6> :
        {{$aduan->nama}}
      </li>
      <li style="list-style: none">
        <h6 style="width: 200px;display: inline-block;margin:0">Tanggal Aduan </h6> :
        {{$aduan->tgl_pengaduan}}
      </li>
      <li style="list-style: none">
        <div class="status">
